...
<body>
    <div class="operate">
        ...
        <a class="operate-bu" href="/moduleOne/heroAction!toCamp.action" >TO CAMP</a>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <s:iterator value="#request.heroList" var="va">
            <tr class="tr-data">
                ...
                <td><input type="text" value="<s:property value="#va.campcode"/>"></td>
            </tr>
        </s:iterator>
    </table>
</body>
